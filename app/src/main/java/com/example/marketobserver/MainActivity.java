...
public class MainActivity extends AppCompatActivity {
    ...
    {
        ((EditText)findViewById(R.id.referenceSystemField)).setText(getIntent()
                .getStringExtra(FieldPassNames.REFERENCE_SYSTEM_PASS_NAME));
        ((EditText)findViewById(R.id.maximalDistanceField)).setText(getIntent()
                .getStringExtra(FieldPassNames.MAXIMAL_DISTANCE_PASS_NAME));
        ((EditText)findViewById(R.id.minimalDemandField)).setText(getIntent()
                .getStringExtra(FieldPassNames.MINIMAL_DEMAND_PASS_NAME));
        ((CheckBox)findViewById(R.id.mPadAllowCheckBox)).setChecked(getIntent()
                .getBooleanExtra(FieldPassNames.ALLOW_MSIZED_PADS_PASS_NAME, false));
    }
