...
public class ResultRecord
{
    ...
    public ResultRecord(Element element)
    {
        ...
        distance = Float.parseFloat(element.child(3).attr("data-order"));
        demand = Integer.parseInt(element.child(4).attr("data-order"));
        price = Integer.parseInt(element.child(5).attr("data-order"));
