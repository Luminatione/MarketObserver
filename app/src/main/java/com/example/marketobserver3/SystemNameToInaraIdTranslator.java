...
public class SystemNameToInaraIdTranslator
{
    ...
    public static String translate(final String systemName) throws IOException
    {
        ...
        connectionManager.requestAndStore(server, new WebsiteConnectionManager.PostData(commodityPostAttributeName, commodityID), new WebsiteConnectionManager.PostData(systemPostAttributeName, systemName));
